defmodule LiveTweets.TweetsTest do
  use LiveTweets.DataCase

  alias LiveTweets.Tweets

  describe "tweets" do
    alias LiveTweets.Tweets.Tweet

    import LiveTweets.TweetsFixtures
    ...
    test "create_tweet/1 with valid data creates a tweet" do
      valid_attrs = %{body: "some body", status: :draft}
